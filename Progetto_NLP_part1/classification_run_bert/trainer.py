...
class CustomTrainer:
    ...
    def evaluate(self, epoch, metric): 
        test_dataset = JsonFastClassificationDataset(EVALUATE_DATASET, "scattered_test/ScatteredTenMillions_test", N_FILE, BertTokenizer.from_pretrained('bert-base-cased'))
